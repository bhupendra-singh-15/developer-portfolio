...
var Swiper = (function () {
  ...
  function Virtual({ swiper, extendParams, on, emit }) {
    ...
    function update(force, beforeInit, forceActiveIndex) {
      ...
      const { addSlidesBefore, addSlidesAfter, slidesPerViewAutoSlideSize } =
      ...
      if (slidesPerView === "auto") {
        if (slidesPerViewAutoSlideSize) {
          ...
          slidesPerViewNumeric = Math.max(
            1,
            Math.ceil(swiperSize / slidesPerViewAutoSlideSize)
          );
        } else {
      ...
      if (centeredSlides) {
        ...
        slidesAfter =
          slidesPerViewNumeric + (slidesPerGroup - 1) + addSlidesAfter;
        slidesBefore =
          (isLoop ? slidesPerViewNumeric : slidesPerGroup) + addSlidesBefore;
      }
